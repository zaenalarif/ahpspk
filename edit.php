...
<section class="content">
	...
	<form class="ui form" method="post" action="edit.php">
		<div class="inline field">
			...
			<input type="text" name="nama" class="form-control form-control-user" value="<?php echo $nama?>">
			<input type="hidden" name="id" value="<?php echo $id?>">
			<input type="hidden" name="jenis" value="<?php echo $jenis?>">
		</div>
		<br>
		<input class="btn btn-primary btn-icon-split" style="padding: 5px;" type="submit" name="update" value="UPDATE">
	</form>
</section>
